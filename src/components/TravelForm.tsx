  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="space-y-2">
        ...
        <Input
          id="city"
          placeholder="e.g., Tokyo, Lisbon, Marrakech"
          value={city}
          onChange={(e) => setCity(e.target.value)}
          required
          className="h-12 bg-background border-border text-base placeholder:text-muted-foreground focus:ring-primary"
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <Input
          id="place"
          placeholder="e.g., Shibuya Crossing, Alfama District"
          value={place}
      ...
      <div className="space-y-2">
        ...
        <Input
          id="time"
          placeholder="e.g., Evening, Summer 2025, March"
          value={time}
